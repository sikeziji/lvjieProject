...
public class Up_content3_7 extends SubFragment {
    private long firstClick;
    private TextView txtCalHitMsg;
    private Left_list4.Callbacks mCallbacks;
    // 计算点击的次数
    private int count;
    private static Up_content3_7 fragment = null;

    public static Up_content3_7 newInstance() {
        if (fragment == null) {
            fragment = new Up_content3_7();
        }
        return fragment;
    }
    ...
    protected int getLayoutResId() {
        return R.layout.up_content3_7_h;
    }
    ...
    protected void DoThings() {
        try {
            ...
            saveExceptInfo2File("组分[" + mCompName + "] Up_content3_7 " + e.toString());
        }
    }
