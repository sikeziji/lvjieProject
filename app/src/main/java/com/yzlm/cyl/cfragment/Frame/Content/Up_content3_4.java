...
public class Up_content3_4 extends SubFragment {
    private long firstClick;
    private TextView txtCalHitMsg;
    private Left_list4.Callbacks mCallbacks;
    // 计算点击的次数
    private int count;
    private static Up_content3_4 fragment = null;

    public static Up_content3_4 newInstance() {
        if (fragment == null) {
            fragment = new Up_content3_4();
        }
        return fragment;
    }
    ...
    protected int getLayoutResId() {
        return R.layout.up_content3_4_h;
    }
    ...
    protected void DoThings() {
        try {
            HorizontalScrollView mHorizontalScrollView = (HorizontalScrollView) v.findViewById(R.id.main_d_hor_view);
            ...
            ImageButton mBtnModuleJJTZ = (ImageButton) v.findViewById(R.id.btn_Module_jjtz);
            mBtnModuleJJTZ.setOnClickListener(new btnJJTZClick());
            ...
            saveExceptInfo2File("组分[" + mCompName + "] Up_content3_4 " + e.toString());
        }
    }
