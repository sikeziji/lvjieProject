...
import com.yzlm.cyl.cfragment.Dialog.Component.Dialog_ExternalKBCoe2;
...
public class List4_Content3_pExtKBCoe2 extends SubFragment {
    private Callbacks mCallbacks;
    private static List4_Content3_pExtKBCoe2 fragment = null;



    public static List4_Content3_pExtKBCoe2 newInstance() {
        if (fragment == null) {
            fragment = new List4_Content3_pExtKBCoe2();
        }
        return fragment;
    }
    ...
    protected void DoThings() {
        try {
            ...
            Dialog_ExternalKBCoe2 dialog_ExtKBCoe = new Dialog_ExternalKBCoe2();
