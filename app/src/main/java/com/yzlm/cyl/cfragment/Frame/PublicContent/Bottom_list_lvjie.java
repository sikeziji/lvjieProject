...
public class Bottom_list_lvjie extends SubFragment {

    private Callbacks mCallbacks;
    private static Bottom_list_lvjie fragment = null;

    public static Bottom_list_lvjie newInstance() {
        if (fragment == null) {
            fragment = new Bottom_list_lvjie();
        }
        return fragment;
    }
    ...
    protected int getLayoutResId() {
        return R.layout.botton_list_h_lvjie;
    }
