...
public class List4_Content3_pUserPassword extends SubFragment {
    private Callbacks mCallbacks;
    private static List4_Content3_pUserPassword fragment = null;

    public static List4_Content3_pUserPassword newInstance() {
        if (fragment == null) {
            fragment = new List4_Content3_pUserPassword();
        }
        return fragment;
    }
    ...
    protected void DoThings() {
        try {
            ...
            bundle.putString("alert-UserPassword", "userPassword1_51");
