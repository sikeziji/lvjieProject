...
public class NoBoard_List1_Content7_pczrz extends SubFragment {
    private Callbacks mCallbacks;
    private static NoBoard_List1_Content7_pczrz fragment = null;

    private TextView tv;
    private int index = 0;
    private NoBoardDevLog mOperationLog;
    private String startTime = null;
    private String endTime = null;
    private ErrorLog.msgType[] types = {ErrorLog.msgType.操作_信息};


    public static NoBoard_List1_Content7_pczrz newInstance() {
        if (fragment == null) {
            fragment = new NoBoard_List1_Content7_pczrz();
        }
        return fragment;
    }
    ...
    protected int getLayoutResId() {
        return R.layout.no_board_list1_content7_pczrz;
    }
    ...
    protected void DoThings() {
        try {
            ...
            mOperationLog = new NoBoardDevLog(context);
            refreshData();
    ...
    private class Select implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            st.setTargetFragment(NoBoard_List1_Content7_pczrz.this, 1);
    ...
    private void refreshData() {
        List<Map> list = mOperationLog.select(mNoBoardCompName, startTime, endTime, types, index);
        if (list.size() == 0) {
            tv.setText("");
            index -= 100;
        } else {
